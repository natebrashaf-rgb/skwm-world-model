  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-3 shadow-sm"><div className="text-xs text-gray-400">热点</div><div className="text-lg font-semibold">N/A</div></div>
        <div className="bg-white border border-gray-200 rounded-lg p-3 shadow-sm"><div className="text-xs text-gray-400">前沿</div><div className="text-lg font-semibold">N/A</div></div>
